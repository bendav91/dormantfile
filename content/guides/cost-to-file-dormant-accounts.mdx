...
The Basic plan is £19/year for one company. The Multiple plan is £39/year for up to 10 companies (£3.90 each). The Agent plan is £49/year for up to 100 companies.
