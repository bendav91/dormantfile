...
If a company is dormant under this definition, it can file simplified [dormant accounts (AA02)](/answers/what-are-dormant-company-accounts-aa02) with Companies House: a balance sheet showing nil figures and a statement that the company was dormant throughout the period.
...
This is the straightforward case. File dormant accounts (AA02) with Companies House and a nil CT600 with HMRC (if registered for Corporation Tax). Both filings confirm the same thing: nothing happened.
...
In these cases, the company cannot file dormant accounts (AA02) with Companies House. It needs full accounts showing the transactions, even though the transactions are small. However, it may still be treated as non-trading by HMRC, depending on the nature of the income.
...
|-----------|----------------------|-------------|
| Dormant AND non-trading | AA02 dormant accounts | Nil CT600 (if registered) |
...
- If dormant under both definitions: file AA02 dormant accounts + nil CT600.
- If non-trading but not dormant: you need full accounts. Dormant accounts (AA02) are not appropriate.
