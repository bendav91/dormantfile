...
- **[Dormant accounts (AA02)](/answers/what-are-dormant-company-accounts-aa02)** submitted to Companies House via their software filing API
...
CATO only handled CT600 returns, not [annual accounts](/answers/what-are-dormant-company-accounts-aa02) with Companies House. We cover how to handle those in our guide on [how to file dormant company accounts](/guides/how-to-file-dormant-company-accounts). Companies House has its own free WebFiling service for accounts, or you can use DormantFile to handle both filings from one place. See [how it works](/how-it-works).
