...
HMRC's free CATO filing tool closed on 31 March 2026, so commercial software is now required to submit CT600 returns. We handle nil CT600 filing alongside your [dormant accounts](/answers/what-are-dormant-company-accounts) — see [how it works](/how-it-works).
