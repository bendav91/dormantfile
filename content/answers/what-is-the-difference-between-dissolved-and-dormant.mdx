...
**Filing obligations:** A dormant company must still file [annual accounts (AA02)](/answers/what-are-dormant-company-accounts-aa02) to Companies House, a [confirmation statement](/answers/what-is-a-confirmation-statement-cs01), and (if registered for Corporation Tax) a [CT600](/answers/what-is-a-ct600) to HMRC every year.
